  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-8 max-w-md w-full text-center">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{error.message || 'An unexpected error occurred.'}</p>
        ...
        <a href="mailto:support@cobrahub.io" className="text-xs text-gray-400 hover:text-gray-600 mt-4 inline-block">Report this issue</a>
      </div>
    </div>
  )
}
